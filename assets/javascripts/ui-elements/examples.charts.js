...
//	})();
	...
	*/
	Morris.Line({
		...
		data: morrisLineData,
		xkey: 'Bulan',
		ykeys: ['PAKET_VIP', 'PAKET_QUAD', 'PAKET_TRIPLE','PAKET_DOUBLE','PAKET_PROMO','PAKET_Promo_Triple','PAKET_PROMO_DOUBLE'],
		labels: ['VIP', 'Quad', 'Triple','Double','Promo','Promo Triple','Promo Double'],
		lineColors: ['#006400', '#8B008B','#FF8C00','#2E8B57','#2E8B57','#FF0000','#000000'],
	});
//Morris.Line({
//		resize: true,
//		element: 'morrisLine',
