...
(function( $ ) {
	...
	*/
	...
	$('#click-to-close-info-FT').click(function() {
		  
		var notice = new PNotify({
			title: 'Klik untuk keluar',
			text: 'Sebelum Mengisi Form Registrasi,<br>Pastikan anda sudah menyiapkan dokumen yang diperlukan.<br>Berikut dokumen data yang di perlukan :<br><br>1. Foto Terbaru<br><br>2. Scan KTP (yang masih berlaku)<br><br>3. Data Rekening Bank.',
			type: 'info',
			addclass: 'click-2-close',
			hide: false,
			buttons: {
