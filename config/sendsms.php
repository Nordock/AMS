<?php
function sendsms($hp, $hpAgent, $message, $module){
	...
	$url = 'http://103.29.214.230:82/smscenter/send.asp?username='.$username.'&password='.$password.'&hp='.$hpAgent.'&message='.$message;
	$url = str_replace(" ","%20",$url);
...
function sendsms_nomodul($hp, $message){
	$username='firsttravel';
	$password='travel01';
