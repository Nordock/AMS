			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						<form id="login" name="login" method="POST" action="validasi.php">
							...
							<div class="row">
								...
								<p class="text-center"><a href="pages-recover-password.html" class="pull">Forgot the Password?</a>
